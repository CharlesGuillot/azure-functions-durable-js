...
export class TestHistories {
    ...
    public static GetSayHelloWithActivityRetryFanout(
        ...
        if (iteration >= 1) {
            historyEvents.push(new OrchestratorStartedEvent(
                {
                    eventId: -1,
                    timestamp: firstTimestamp,
                    isPlayed: iteration > 1,
            ...
            historyEvents.push(new ExecutionStartedEvent(
                {
                    eventId: -1,
                    timestamp: firstTimestamp,
                    isPlayed: iteration > 1,
            ...
            historyEvents.push(new TaskScheduledEvent(
                {
                    eventId: 0,
                    timestamp: firstTimestamp,
                    isPlayed: iteration > 1,
            ...
            historyEvents.push(new OrchestratorCompletedEvent(
                {
                    eventId: -1,
                    timestamp: firstTimestamp,
                    isPlayed: iteration > 1,
        ...
        if (iteration >= 2) {
            ...
            historyEvents.push(new TaskFailedEvent(
                {
                    eventId: -1,
            ...
            historyEvents.push(new TimerCreatedEvent(
                {
                    eventId: 2,
                    timestamp: firstMoment.add(100, "ms").toDate(),
                    isPlayed: iteration > 2,
            ...
            historyEvents.push(new TaskCompletedEvent(
                {
                    eventId: -1,
                    timestamp: firstMoment.add(100, "s").add(retryInterval, "ms").add(100, "ms").toDate(),
                    isPlayed: iteration > 2,
                    result: JSON.stringify(`Hello, Seattle!`),
                    taskScheduledId: 1,
                },
        ...
        if (iteration >= 3) {
            ...
            historyEvents.push(new TimerFiredEvent(
                {
                    eventId: -1,
    ...
    public static GetSayHelloWithSuborchestratorRetryFanout(
        ...
        if (iteration >= 2) {
            ...
            historyEvents.push(new SubOrchestrationInstanceFailedEvent(
                {
                    eventId: -1,
                    timestamp: firstMoment.add(100, "ms").toDate(),
                    isPlayed: iteration > 2,
